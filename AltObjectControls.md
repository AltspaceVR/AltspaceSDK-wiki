AltObjectControls can be created and managed by [[CursorEvents]] (see method `enableMouseEvents`) so generally you will **not need to instantiate this class directly**.
